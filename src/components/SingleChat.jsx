...
import { getSender, getSenderFull } from "../context/reducer";
...
export default function SingleChat({ fetchAgain, setFetchAgain }) {
  const [{ user, chats, selectedChat, notification }, dispatch] =
    useStateValue();
      ...
      if (
        ...
        if (!notification.includes(newMessageRecieved)) {
          dispatch({
            ...
            notification: newMessageRecieved,
          });
    ...
    <>
      {selectedChat ? (
        ...
        <Box
          ...
          h="100%"
        >
          <Text fontSize="3xl" pb={3} color={"grey"}>
